...
from svnfiltereddump import Config, DumpController, STRATEGY_DUMP_HEADER, STRATEGY_IGNORE, STRATEGY_SYNTHETIC_DELETES, STRATEGY_DUMP_SCAN, STRATEGY_BOOTSTRAP
...
class TestDumpController(TestCase):
    def setUp(self):
        ...
        handler_map = { }
        for strategy in [ STRATEGY_DUMP_HEADER, STRATEGY_IGNORE, STRATEGY_SYNTHETIC_DELETES, STRATEGY_DUMP_SCAN, STRATEGY_BOOTSTRAP ]:
    ...
    def test_bootstrap(self):
        ...
        self.controller.run()
        self.assertEqual(self.process_log, [ '-1/'+STRATEGY_DUMP_HEADER, '5/'+STRATEGY_BOOTSTRAP, '6/'+STRATEGY_DUMP_SCAN ])
        self.assertEqual(self.aux_data_by_rev, { })
